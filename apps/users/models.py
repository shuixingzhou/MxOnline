...
class UserProfile(AbstractUser):
    ...
    gender = models.CharField(choices=(('male', '男'), ('female', '女')), verbose_name='性别', max_length=6)
    address = models.CharField(max_length=100, default='', verbose_name='地址')
    mobile = models.CharField(max_length=11, default='', verbose_name='手机')
    image = models.ImageField(upload_to='image/%Y/%m', verbose_name='头像', default='image/default.jpg')
...
class EmailVerifyRecord(models.Model):
    ...
    send_type = models.CharField(choices=(('register', '注册'), ('forget', '找回密码'), ('update_email', '修改邮箱')),
                                 max_length=20, verbose_name='发送类型')
